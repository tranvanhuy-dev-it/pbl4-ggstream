...
export const ScreenShareOnIcon = (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 8v5m0-5l-2.5 2.5M12 8l2.5 2.5" />
  </svg>
);
...
export const PhoneHangupIcon = (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" stroke="none">
    <path d="M12 9c-3.5 0-6.6 1.1-9.1 2.9a1 1 0 00-.2 1.4l1.9 2.5a1 1 0 001.4.2c.9-.6 1.9-1.1 2.9-1.4a1 1 0 00.7-1v-1.9c1.4-.3 2.9-.3 4.3 0v1.9a1 1 0 00.7 1c1 .3 2 .8 2.9 1.4a1 1 0 001.4-.2l1.9-2.5a1 1 0 00-.2-1.4C18.6 10.1 15.5 9 12 9z" />
  </svg>
);

export const NetworkStatsIcon = (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
